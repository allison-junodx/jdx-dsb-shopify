...
class JotformAPIClient:
    DEFAULT_BASE_URL = 'https://junodx.jotform.com/'
    ...
    def __init__(self, api_key=None, base_url=DEFAULT_BASE_URL, output_type='json', debug=False):
        self._api_key = api_key
        self._base_url = base_url
        self._outputType = output_type.lower()
    ...
    def get_form_submissions(self, form_id, offset=None, limit=None, filterArray=None, order_by=None):
        ...
        r = requests.get(f'{self.base_url}/API/form/{form_id}/submissions', params=params)
    ...
    def delete_form_webhook(self, formID, webhookID):
        ...
        Args:
            formID (string): Form ID is the numbers you see on a form URL. You can get form IDs when you call /user/forms.
            webhookID (string): You can get webhook IDs when you call /form/{form_id}/webhooks.
        Returns:
...
def parse_form_names(name_dict):
    return name_dict['first'], name_dict['last']


def parse_form_dates(date_dict):
    return date_dict['datetime']