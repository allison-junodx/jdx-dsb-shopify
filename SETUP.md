...
```bash
git clone git@github.com:manifoldai/jdx_dsb_shopify.git
```
...
The runtime for jdx-dsb-shopify is inside a Docker container. We have a `make` command to launch the appropriate containers. To launch the docker containers and begin working on a CPU, run from the root directory of the repository:
...
c5df791a2731   jdx_dsb_shopify_develop   "bash -c 'cd /mnt &&…"   3 seconds ago   Up 1 second   127.0.0.1:55003->8888/tcp                              jdx_dsb_shopify_develop_<username>
451fa5f876dc   jdx_dsb_shopify_mlflow    "bash -c 'mlflow ser…"   3 seconds ago   Up 1 second   127.0.0.1:55004->5000/tcp                              jdx_dsb_shopify_mlflow_<username>
```
