...
```bash
pytest jdx_dsb_shopify/scripts/test_evaluate.py -v
```

You can even just run a specific test by issuing a command like: 
```bash
pytest jdx_dsb_shopify/scripts/test_evaluate.py::test_evaluate -v
```
...
f168e19b8b67        jdx_dsb_shopify_mlflow            "bash -c 'mlflow ui …"   4 days ago          Up 3 days           127.0.0.1:32770->5000/tcp   jdx_dsb_shopify_mlflow_<username>
87f03baf686e        jdx_dsb_shopify_bash     "/bin/bash"              4 days ago          Up 4 days           127.0.0.1:32768->8501/tcp   jdx_dsb_shopify_bash_<username>
d9bd01600486        jdx_dsb_shopify_develop   "bash -c 'cd /mnt &&…"   4 days ago          Up 3 days           127.0.0.1:32769->8888/tcp   jdx_dsb_shopify_develop_<username>
```
