...
```bash
$ make bash
$ python jdx_dsb_shopify/scripts/etl.py configs/config.yml
```
...
```bash
python jdx_dsb_shopify/scripts/evaluate.py configs/example.yml
```
...
└── jdx_dsb_shopify    <- Project source directory
