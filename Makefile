...
CONTAINER_NAME="jdx_dsb_shopify_develop_${USER}"

PROJECT=jdx_dsb_shopify

PROJ_DIR="/mnt/jdx_dsb_shopify"
...
ci-isort: dev-start ## Test lint compliance with isort.
...
ci: ci-isort ci-black ci-flake8 ci-test ci-mypy ## Check isort, black, flake8, mypy, and run unit tests
	@echo "CI successful"

isort: dev-start ## Runs isort to sort imports
...
format: isort black ## Formats repo by running isort and black on all files
...
lab: dev-start ## Opens Jupyterlab in the browser
